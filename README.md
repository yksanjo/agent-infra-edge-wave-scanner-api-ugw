# agent-infra-edge-wave-scanner-api-ugw

## Detailed Description

agent-infra-edge-wave-scanner-api-ugw is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
